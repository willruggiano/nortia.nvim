...
local theme = lush(function()
  return {
    ...
    Palette2 { fg = hsl(nortia.palette(function(x)
      return nortia.rotate(x, -45)
    end)) },
    Palette3 { fg = hsl(nortia.palette(function(x)
      return nortia.rotate(x, 30)
    end)) },
    Palette4 { fg = hsl(nortia.palette(function(x)
      return nortia.rotate(x, -75)
    end)) },
    Palette5 { fg = hsl(nortia.palette(function(x)
      return nortia.rotate(x, 150)
    end)) },
    Palette6 { fg = hsl(nortia.palette(function(x)
      return nortia.rotate(x, 190)
    end)) },
    ...
    CursorLine { bg = Back3.bg }, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
